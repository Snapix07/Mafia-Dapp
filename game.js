...
const TOKEN_ADDRESS = '0x0b7CA53cb4f6c20be8f37ED6e5A3Ea6466FeE742'
...
async function init() {
  ...
  try {
    ...
    if (balanceDiv) {
      balanceDiv.innerText = `Tokens: ${tokenBalance} MFT`
    }
  } catch (e) {
...
async function loadGame() {
  ...
  const winnerIdx = Number(info[4]) // ИСПРАВЛЕНО: индекс 4, не 5
